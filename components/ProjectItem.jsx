...
const ProjectItem = ({ title, alt, tech, bgImg, projectURL, githubURL }) => {
    return (
        <div className='bg-white border hover:bg-gradient-to-r from-[#001f54] to-[#002668] relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-200 rounded-xl p-4 group'>
